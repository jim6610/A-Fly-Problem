...
public class Destructible : MonoBehaviour {
    ...
    [SerializeField] private GameObject[] hiddenPieces; // list of the objects that will be hidden after the object breaks
    ...
    void Shatter()
    {
        ...
        {
            foreach (GameObject hidingObj in hiddenPieces)
            {
